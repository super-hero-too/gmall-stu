package com.ls.demo.gmallmybatisplus1.generator;
...
public class MyBatisPlusGenerator {
    ...
    private static GlobalConfig initGlobalConfig(String projectPath) {
        ...
        globalConfig.setEntityName("%s");//设置实体类后置名都有
        globalConfig.setMapperName("%sMapper");//设置数据库访问类以Mapper结尾
        globalConfig.setXmlName("%sMapper");//xmlMapper配置文件 以Mapper结尾
        globalConfig.setServiceName("%sService");//service以Service结尾
        globalConfig.setServiceImplName("%sServiceImpl");//ServiceImpl结尾
        globalConfig.setControllerName("%sController");//Controller结尾
        return globalConfig;
    }
